...
// time type is like 'h'
// return jsdate
function addTime(jsdate, timevalue, timetype) {
    let curms = jsdate.getTime();
    if (timetype == 'ms') {
        curms += timevalue;
    }
    else if (timetype == 's') {
        curms += timevalue * 1000;
    }
    else if (timetype == 'm') {
        curms += timevalue * 60 * 1000;
    }
    else if (timetype == 'h') {
        curms += timevalue * 60 * 60 * 1000;
    }
    else if (timetype == 'd') {
        curms += timevalue * 24 * 60 * 60 * 1000;
    }
